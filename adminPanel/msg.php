...
$link=mysqli_connect("shareddb-g.hosting.stackcp.net","rushabh","Rushabh@123","sample-32371144");
	...
	$area=$_GET['area'];
	$msg="Please Clean the Dustbin in area ".$area." as soon as possible";
...
$text="Please Clean the Dustbin in area ".$area." as soon as possible";
...
if (!function_exists('json_encode')) {
	...
	$Textlocal = new Textlocal(false, false, 'cR62f3HkOig-V943tLvnFMlQEIKCADgyr2PPi5593O');
 
	$mobile=$_GET['mobile'];
	$numbers = array($mobile);
	$sender = 'TXTLCL';
	$message = "Please Clean the Dustbin in area ".$area." as soon as possible";;
