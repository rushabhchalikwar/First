...
$link=mysqli_connect("shareddb-g.hosting.stackcp.net","rushabh","Rushabh@123","sample-32371144");
	...
	$query="INSERT INTO signupforusers(fullName,username,Address,contact,email,date,area,password) 					 VALUES('$fullName','$username','$Address','$contact','$email','$date','$area','$password')";
...
$new_file=$target_dir.$username.".jpg";
echo $target_file;
$uploadOk = 1;
